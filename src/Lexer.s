...
# ST (Global ("srcTab")) / 
	...
	movl	%ebx,	global_srcTab
# DROP / 

# LINE (24) / 

	.stabn 68,0,24,.L1-initLexer
...
# BEGIN ("Llambda_0", 1, 0, [], ["k"], [{ blab="L218"; elab="L219"; names=[]; subs=[{ blab="L221"; elab="L222"; names=[]; subs=[]; }]; }]) / 
...
# BEGIN ("Llambda_1_3", 1, 2, [Arg (0)], ["s"], [{ blab="L223"; elab="L224"; names=[]; subs=[{ blab="L226"; elab="L227"; names=[]; subs=[{ blab="L254"; elab="L255"; names=[("a", 0)]; subs=[{ blab="L256"; elab="L257"; names=[]; subs=[]; }]; }; { blab="L237"; elab="L238"; names=[("a", 1); ("v", 0)]; subs=[{ blab="L239"; elab="L240"; names=[]; subs=[{ blab="L252"; elab="L253"; names=[]; subs=[]; }; { blab="L245"; elab="L246"; names=[]; subs=[]; }]; }]; }]; }]; }]) / 
	...
	.stabn 192,0,0,L254-Llambda_1_3

	.stabn 224,0,0,L255-Llambda_1_3

	.stabs "a:1",128,0,0,-8

	.stabs "v:1",128,0,0,-4

	.stabn 192,0,0,L237-Llambda_1_3

	.stabn 224,0,0,L238-Llambda_1_3
...
# BEGIN ("Ls", 1, 0, [], ["t"], [{ blab="L258"; elab="L259"; names=[]; subs=[{ blab="L261"; elab="L262"; names=[]; subs=[]; }]; }]) / 
...
# BEGIN ("LgetLoc", 1, 1, [], ["s"], [{ blab="L269"; elab="L270"; names=[]; subs=[{ blab="L272"; elab="L273"; names=[]; subs=[{ blab="L280"; elab="L281"; names=[("loc", 0)]; subs=[{ blab="L282"; elab="L283"; names=[]; subs=[]; }]; }]; }]; }]) / 
	...
	.stabn 192,0,0,L280-LgetLoc

	.stabn 224,0,0,L281-LgetLoc
...
# BEGIN ("Llocated", 1, 0, [], ["p"], [{ blab="L284"; elab="L285"; names=[]; subs=[{ blab="L287"; elab="L288"; names=[]; subs=[]; }]; }]) / 
...
# LINE (14) / 
	...
	.stabn 68,0,14,.L50-Llocated

.L50:

# CLOSURE ("Llambda_2_19", [Arg (0)]) / 
...
# BEGIN ("Llambda_2_19", 1, 0, [Arg (0)], ["l"], [{ blab="L291"; elab="L292"; names=[]; subs=[{ blab="L294"; elab="L295"; names=[]; subs=[]; }]; }]) / 

	.type lambda_2_19, @function

	.stabs "lambda_2_19:F1",36,0,0,Llambda_2_19
	...
	subl	$LLlambda_2_19_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLlambda_2_19_SIZE,	%ecx
	rep movsl	
# SLABEL ("L291") / 
...
LLlambda_2_19_epilogue:
	...
	.set	LLlambda_2_19_SIZE,	0

	.set	LSLlambda_2_19_SIZE,	0

	.size Llambda_2_19, .-Llambda_2_19

# LABEL ("Llambda_3_21") / 

Llambda_3_21:

# BEGIN ("Llambda_3_21", 1, 0, [Arg (0)], ["x"], [{ blab="L298"; elab="L299"; names=[]; subs=[{ blab="L301"; elab="L302"; names=[]; subs=[]; }]; }]) / 
