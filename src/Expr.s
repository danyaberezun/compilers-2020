	.file "/home/alexey/study/compilershw1/compilers-2020/src/Expr.lama"

	.stabs "/home/alexey/study/compilershw1/compilers-2020/src/Expr.lama",100,0,0,.Ltext
...
# BEGIN ("LevalOp", 3, 0, [], ["op"; "l"; "r"], [{ blab="L40"; elab="L41"; names=[]; subs=[{ blab="L43"; elab="L44"; names=[]; subs=[{ blab="L131"; elab="L132"; names=[]; subs=[{ blab="L133"; elab="L134"; names=[]; subs=[]; }]; }; { blab="L125"; elab="L126"; names=[]; subs=[{ blab="L127"; elab="L128"; names=[]; subs=[]; }]; }; { blab="L118"; elab="L119"; names=[]; subs=[{ blab="L120"; elab="L121"; names=[]; subs=[]; }]; }; { blab="L111"; elab="L112"; names=[]; subs=[{ blab="L113"; elab="L114"; names=[]; subs=[]; }]; }; { blab="L104"; elab="L105"; names=[]; subs=[{ blab="L106"; elab="L107"; names=[]; subs=[]; }]; }; { blab="L97"; elab="L98"; names=[]; subs=[{ blab="L99"; elab="L100"; names=[]; subs=[]; }]; }; { blab="L90"; elab="L91"; names=[]; subs=[{ blab="L92"; elab="L93"; names=[]; subs=[]; }]; }; { blab="L83"; elab="L84"; names=[]; subs=[{ blab="L85"; elab="L86"; names=[]; subs=[]; }]; }; { blab="L76"; elab="L77"; names=[]; subs=[{ blab="L78"; elab="L79"; names=[]; subs=[]; }]; }; { blab="L69"; elab="L70"; names=[]; subs=[{ blab="L71"; elab="L72"; names=[]; subs=[]; }]; }; { blab="L62"; elab="L63"; names=[]; subs=[{ blab="L64"; elab="L65"; names=[]; subs=[]; }]; }; { blab="L55"; elab="L56"; names=[]; subs=[{ blab="L57"; elab="L58"; names=[]; subs=[]; }]; }; { blab="L48"; elab="L49"; names=[]; subs=[{ blab="L50"; elab="L51"; names=[]; subs=[]; }]; }]; }]; }]) / 
