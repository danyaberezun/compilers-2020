	.file "/home/alexey/study/compilershw1/compilers-2020/src/Stmt.lama"

	.stabs "/home/alexey/study/compilershw1/compilers-2020/src/Stmt.lama",100,0,0,.Ltext
...
# BEGIN ("Leval", 2, 5, [], ["__tmp0"; "stmt"], [{ blab="L16"; elab="L17"; names=[]; subs=[{ blab="L23"; elab="L24"; names=[("c", 2); ("st", 1); ("w", 0)]; subs=[{ blab="L25"; elab="L26"; names=[]; subs=[{ blab="L86"; elab="L87"; names=[("expr", 3)]; subs=[{ blab="L88"; elab="L89"; names=[]; subs=[]; }]; }; { blab="L80"; elab="L81"; names=[]; subs=[{ blab="L82"; elab="L83"; names=[]; subs=[]; }]; }; { blab="L58"; elab="L59"; names=[("x", 3)]; subs=[{ blab="L60"; elab="L61"; names=[("new_w", 4)]; subs=[]; }]; }; { blab="L47"; elab="L48"; names=[("stmt1", 4); ("stmt2", 3)]; subs=[{ blab="L49"; elab="L50"; names=[]; subs=[]; }]; }; { blab="L32"; elab="L33"; names=[("x", 4); ("expr", 3)]; subs=[{ blab="L34"; elab="L35"; names=[]; subs=[]; }]; }]; }]; }]; }]) / 
