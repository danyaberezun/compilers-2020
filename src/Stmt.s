...
# BEGIN ("Leval", 2, 7, [], ["condition"; "statement"], [{ blab="L16"; elab="L17"; names=[]; subs=[{ blab="L19"; elab="L20"; names=[]; subs=[{ blab="L27"; elab="L28"; names=[("state", 2); ("in", 1); ("out", 0)]; subs=[{ blab="L29"; elab="L30"; names=[]; subs=[{ blab="L158"; elab="L159"; names=[("s1", 4); ("elem", 3)]; subs=[{ blab="L160"; elab="L161"; names=[]; subs=[{ blab="L168"; elab="L169"; names=[("condition", 6); ("state", 5)]; subs=[{ blab="L170"; elab="L171"; names=[]; subs=[{ blab="L185"; elab="L186"; names=[]; subs=[{ blab="L187"; elab="L188"; names=[]; subs=[]; }]; }; { blab="L177"; elab="L178"; names=[]; subs=[{ blab="L179"; elab="L180"; names=[]; subs=[]; }]; }]; }]; }]; }]; }; { blab="L133"; elab="L134"; names=[("elem", 4); ("s1", 3)]; subs=[{ blab="L135"; elab="L136"; names=[]; subs=[{ blab="L146"; elab="L147"; names=[]; subs=[{ blab="L148"; elab="L149"; names=[]; subs=[]; }]; }; { blab="L142"; elab="L143"; names=[]; subs=[{ blab="L144"; elab="L145"; names=[]; subs=[]; }]; }]; }]; }; { blab="L109"; elab="L110"; names=[("elem", 5); ("s1", 4); ("s2", 3)]; subs=[{ blab="L111"; elab="L112"; names=[]; subs=[{ blab="L124"; elab="L125"; names=[]; subs=[{ blab="L126"; elab="L127"; names=[]; subs=[]; }]; }; { blab="L118"; elab="L119"; names=[]; subs=[{ blab="L120"; elab="L121"; names=[]; subs=[]; }]; }]; }]; }; { blab="L98"; elab="L99"; names=[("s1", 4); ("s2", 3)]; subs=[{ blab="L100"; elab="L101"; names=[]; subs=[]; }]; }; { blab="L81"; elab="L82"; names=[("elem", 4); ("e", 3)]; subs=[{ blab="L83"; elab="L84"; names=[]; subs=[]; }]; }; { blab="L66"; elab="L67"; names=[("elem", 3)]; subs=[{ blab="L68"; elab="L69"; names=[]; subs=[]; }]; }; { blab="L43"; elab="L44"; names=[("elem", 3)]; subs=[{ blab="L45"; elab="L46"; names=[]; subs=[{ blab="L51"; elab="L52"; names=[("el", 5); ("inn", 4)]; subs=[{ blab="L53"; elab="L54"; names=[]; subs=[]; }]; }]; }]; }; { blab="L36"; elab="L37"; names=[]; subs=[{ blab="L38"; elab="L39"; names=[]; subs=[]; }]; }]; }]; }]; }]; }]) / 
