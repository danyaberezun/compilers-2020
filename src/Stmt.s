...
string_0:	.string	"Stmt eval not implemented\n"
...
# BEGIN ("Leval", 2, 0, [], ["c"; "stmt"], [{ blab="L16"; elab="L17"; names=[]; subs=[{ blab="L19"; elab="L20"; names=[]; subs=[]; }]; }]) / 
...
# STRING ("Stmt eval not implemented\\n") / 
