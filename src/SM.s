...
# BEGIN ("LshowSM", 1, 0, [], ["prg"], [{ blab="L265"; elab="L266"; names=[]; subs=[{ blab="L268"; elab="L269"; names=[]; subs=[]; }]; }]) / 
...
# BEGIN ("Llambda_0_42", 1, 0, [], ["i"], [{ blab="L273"; elab="L274"; names=[]; subs=[{ blab="L276"; elab="L277"; names=[]; subs=[]; }]; }]) / 

	.type lambda_0_42, @function

	.stabs "lambda_0_42:F1",36,0,0,Llambda_0_42
	...
	subl	$LLlambda_0_42_SIZE,	%esp
	movl	%esp,	%edi
	movl	$filler,	%esi
	movl	$LSLlambda_0_42_SIZE,	%ecx
	rep movsl	
# SLABEL ("L273") / 
...
LLlambda_0_42_epilogue:
	...
	.set	LLlambda_0_42_SIZE,	0

	.set	LSLlambda_0_42_SIZE,	0

	.size Llambda_0_42, .-Llambda_0_42

# LABEL ("LshowSMInsn") / 

LshowSMInsn:

# BEGIN ("LshowSMInsn", 1, 1, [], ["i"], [{ blab="L281"; elab="L282"; names=[]; subs=[{ blab="L284"; elab="L285"; names=[]; subs=[{ blab="L333"; elab="L334"; names=[("n", 0)]; subs=[{ blab="L335"; elab="L336"; names=[]; subs=[]; }]; }; { blab="L325"; elab="L326"; names=[("x", 0)]; subs=[{ blab="L327"; elab="L328"; names=[]; subs=[]; }]; }; { blab="L316"; elab="L317"; names=[("x", 0)]; subs=[{ blab="L318"; elab="L319"; names=[]; subs=[]; }]; }; { blab="L307"; elab="L308"; names=[("s", 0)]; subs=[{ blab="L309"; elab="L310"; names=[]; subs=[]; }]; }; { blab="L299"; elab="L300"; names=[]; subs=[{ blab="L301"; elab="L302"; names=[]; subs=[]; }]; }; { blab="L291"; elab="L292"; names=[]; subs=[{ blab="L293"; elab="L294"; names=[]; subs=[]; }]; }]; }]; }]) / 
	...
	.stabn 192,0,0,L325-LshowSMInsn

	.stabn 224,0,0,L326-LshowSMInsn

	.stabs "x:1",128,0,0,-4

	.stabn 192,0,0,L316-LshowSMInsn

	.stabn 224,0,0,L317-LshowSMInsn

	.stabs "s:1",128,0,0,-4

	.stabn 192,0,0,L307-LshowSMInsn

	.stabn 224,0,0,L308-LshowSMInsn
